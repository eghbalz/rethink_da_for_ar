...
# }
cfg = {
    'VGG11': [[1, 64, 'M'], [64, 128, 'M'], [128, 256, 256, 'M'], [256, 512, 512, 'M'], [512, 512, 512, 'M']],
    'VGG13': [[1, 64, 64, 'M'], [64, 128, 128, 'M'], [128, 256, 256, 'M'], [256, 512, 512, 'M'], [512, 512, 512, 'M']],
    'VGG16': [[1, 64, 64, 'M'], [64, 128, 128, 'M'], [128, 256, 256, 256, 'M'], [256, 512, 512, 512, 'M'],
              [512, 512, 512, 512, 'M']],
    'VGG19': [[1, 64, 64, 'M'], [64, 128, 128, 'M'], [128, 256, 256, 256, 256, 'M'], [256, 512, 512, 512, 512, 'M'],
...
class VGG(nn.Module):
    ...
    def forward(self, x, **kwargs):
        ...
        assert (not kwargs['fake_relu']) and (not kwargs['no_relu']),  \
