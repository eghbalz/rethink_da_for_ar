...
# }
cfg = {
    'VGG11': [[3, 64, 'M'], [64, 128, 'M'], [128, 256, 256, 'M'], [256, 512, 512, 'M'], [512, 512, 512, 'M']],
    'VGG13': [[3, 64, 64, 'M'], [64, 128, 128, 'M'], [128, 256, 256, 'M'], [256, 512, 512, 'M'], [512, 512, 512, 'M']],
    'VGG16': [[3, 64, 64, 'M'], [64, 128, 128, 'M'], [128, 256, 256, 256, 'M'], [256, 512, 512, 512, 'M'],
              [512, 512, 512, 512, 'M']],
    'VGG19': [[3, 64, 64, 'M'], [64, 128, 128, 'M'], [128, 256, 256, 256, 256, 'M'], [256, 512, 512, 512, 512, 'M'],
