...
class MNISTDSET(MNIST):
    r"""MNIST dataset with deterministic transform-based augmentations.
    ...
    def __init__(self, root, train, augmentation_config_file, device, transform=None, target_transform=None,
        ...
        if transform is None:
            ...
            self.transform = get_transforms(self.augmentation_dict, ds_name='mnist')
        else:
