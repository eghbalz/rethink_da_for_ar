...
import torch
from torchvision.datasets.mnist import KMNIST
...
class KMNISTDSET(KMNIST):
    ...
    def __init__(self, root, train, augmentation_config_file, device, transform=None,target_transform=None,
        ...
        if transform is None:
            ...
            self.transform = get_transforms(self.augmentation_dict, ds_name='kmnist')
        else:
    ...
    def get_model(self, arch, pretrained):
        ...
        if pretrained:
            raise ValueError('KMNIST does not support pytorch_pretrained=True')
